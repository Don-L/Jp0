...
/***/ function(module, exports, __webpack_require__) {
	...
	var Jp0 = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(Jp0, null), document.getElementById('app'));
	};
	...
	var Jp0 = React.createClass({
	  ...
	  showTableWithSelected: function showTableWithSelected(char, all) {
	    ...
	    if (this.state.hiragana[char].yoon_parent) {
	      var ch = this.state.hiragana[char].yoon_parent;
	  ...
	  setTableType: function setTableType(type) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KanjiDisplay = React.createClass({
	  displayName: 'KanjiDisplay',
	
	
	  render: function render() {
	
	    var clss = 'Kanji hrg' + this.props.kanjiChars.length;
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'p',
	        { className: clss, onClick: this.showTableWithAllSelected },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var HirChar = __webpack_require__(164);
	
	var HiraganaDisplay = React.createClass({
	  displayName: 'HiraganaDisplay',
	  ...
	  render: function render() {
	    ...
	    var clss = 'HiraganaDisplay' + ' hrg' + flattened.length;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Hint = __webpack_require__(166);
	...
	var Hint = React.createClass({
	  ...
	  render: function render() {
	    ...
	    if (revealed.indexOf(hintIndex) > -1) {
	      ...
	      var blanks = [];
	      for (var i = 0; i < this.props.hint.length; i++) {
	        blanks.push('\u2022');
	      }
	      return React.createElement(
	        'div',
	  ...
	  render: function render() {
	    ...
	    var gojuonTable = React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(TableTab, { tabName: 'gojūon', setTableType: this.props.setTableType, tableType: this.props.tableType }),
	        React.createElement(TableTab, { tabName: '゛、゜', setTableType: this.props.setTableType, tableType: this.props.tableType }),
	        React.createElement(TableTab, { tabName: 'yōon', setTableType: this.props.setTableType, tableType: this.props.tableType })
	      ),
	      React.createElement(
	        'table',
	        null,
